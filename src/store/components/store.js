        ...
        <>
            <div title="Store">
                ...
                <header className="header">
                    ...
                    <Link className="header-child" to="/cart" onClick={handleCartIcon}><img className="header-icon" src="/cart.png" /> Cart ({cart.length > 0 ? cart.map(e => e.quantity).reduce((a, b) => a + b) : 0})</Link>
                </header>
            </div>
            <div>
                {
